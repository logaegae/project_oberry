...
$(document).ready(function(){
  ...
  //쿠키 가져오기
    ...
    if(navigator.platform){
        if(0 > filter.indexOf(navigator.platform.toLowerCase())){
          ...
          cookieFn($('.nocice_mobile'),'oberrygood6');
        }else{
          cookieFn($('.pop1'),'oberrygood1');
          cookieFn($('.pop2'),'oberrygood2');
          cookieFn($('.notice_pc'),'oberrygood5');
  ...
  $('#pop_4_today').on("click",function(){
    ...
    $('#open_pop').children('.pop4').css({
      ...
      //notice
  $('#notice_pc_today').on("click",function(){
    setCookie("oberrygood5", "done", 1);
    $('#notice_pop').children('.notice_pc').css({
      'display':'none'
    });
  });
  $('#notice_mobile_today').on("click",function(){
    setCookie("oberrygood6", "done", 1);
    $('#notice_pop').children('.nocice_mobile').css({
      'display':'none'
    });
  });
 ...
 //pop_close
  ...
  $('#pop_4_close').on("click",function(){
    $('#open_pop').children('.pop4').css({
      ...
      //notice
  $('#notice_pc_close').on("click",function(){
    $('#notice_pop').children('.notice_pc').css({
      'display':'none'
    });
  });
  $('#notice_mobile_close').on("click",function(){
    $('#notice_pop').children('.nocice_mobile').css({
      'display':'none'
    });
  });
